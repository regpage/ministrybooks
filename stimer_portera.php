...
echo "Дождливыми вечерами мы читали книги под лампой<br><br><br><br>"; 

$stemmer = new Lingua_Stem_Ru();
echo $stemmer->stem_string('Дождливыми вечерами мы читали книги под лампой');//дождлив вечер мы чита книг ламп
