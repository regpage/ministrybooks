...
SpawConfig::setStaticConfigItem('SPAW_DIR', SpawConfig::getStaticConfigValue("SPAW_ROOT"));
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    ...
    'max_upload_filesize' => 2097152,             // max upload file size allowed in bytes, or 0 to ignore
