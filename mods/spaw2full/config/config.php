...
SpawConfig::setStaticConfigItem('SPAW_DIR', 'mods/spaw2full/');
...
SpawConfig::setStaticConfigItem('DOCUMENT_ROOT', 'var/www/vhosts/ministrybooks.ru/httpdocs/');
SpawConfig::setStaticConfigItem('SPAW_ROOT', 'var/www/vhosts/ministrybooks.ru/httpdocs/mods/spaw2full/');
SpawConfig::setStaticConfigItem('SPAW_DIR', '/mods/spaw2full/');
*/
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    ...
    'forbid_extensions_strict' => false,     // disallow specified extensions in the middle of the filename
  ),
  SPAW_CFG_TRANSFER_SECURE
);
