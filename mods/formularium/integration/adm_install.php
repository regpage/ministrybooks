<?php
  ...
  //вставляем дамп
  $dump = file_get_contents("../../../mods/formularium/install/dump.inc");
  ...
  //копируем языковые фалы
  copy_dir("../../../mods/formularium/langfiles/", "../../../langfiles/");
  ...
  if(is_array($sites))
  {
    ...
    for($i = 0; $i < $cnt; $i++)
    {
      ...
      //переносим языковые файлы
     copy_dir("../../../mods/formularium/langfiles/", "../../../{$s_path_to_root}langfiles/");
