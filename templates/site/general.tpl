...
<html class=" js no-touch svg inlinesvg svgclippaths no-ie8compat" lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- javascript -->
  	<script type="text/javascript" async src="themes/general/index/ga.js"></script><script src="themes/general/index/custom.modernizr.js"></script>
...
<div id="header">
  <div class="row">
          <div class="large-12 columns">
               <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/"><img src="themes/general/index/lsm-logo.png" alt="Living Stream Ministry logo" class="logo"></a>
               <h1>Коллектор библейской книги</h1>
               <h2>Издатель книг Вочмана Ни и Уитнесса Ли</h2>
          </div>
    </div>
    <div class="row">
          <div class="large-12 columns spanish-link"> 
<a href="http://www.kbk.ru/">Официальный сайт издательсва</a>        	
          </div>
    </div>
</div>
<div class="contain-to-grid sticky">
  ...
  <section class="top-bar-section" style="left: 0%;">
      <ul class="left">
        ...
        <li class="has-dropdown not-click"><a href="/?mod=witness_lee_books">Книги Уитнесса Ли</a>
          <ul class="dropdown"><li class="title back js-generated"><h5><a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/#">« Назад</a></h5></li><li><a class="parent-link js-generated" href="/?mod=witness_lee_books">Книги Уитнесса Ли</a></li>
        ...
        <li class="has-dropdown not-click"><a href="/?mod=kbk_websites">Cайты КБК</a>
          <ul class="dropdown"><li class="title back js-generated"><h5><a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/#">« Назад</a></h5></li><li><a class="parent-link js-generated" href="/?mod=kbk_websites">Cайты КБК</a></li>
            <li><a href="http://www.kbk.ru/">Коллектор библейской книги</a></li>
            <li><a href="http://www.recoveryversion.ru/">Новый завет онлайн</a></li>
            <li><a href="http://kbk.ru/set/radio/programs/">Радиопрограммы</a></li>
          </ul>
        </li>
    ...
    <div class="large-12 columns">
      <div class="row">
       	<div class="large-5 columns">
         	<h4>Другие онлайн публикации</h4>
          <ul class="vertical">            
            <li><a href="http://forfaith.ru/">Защищая веру</a></li>
            <li><a href="http://www.lsm.org/epublications.html">Электронные публикации на англ.</a></li>
            <li><a href="http://recoveryversion.ru/">Восстановительный перевод нового завета</a></li>            
          </ul>
       	</div>
...
<div id="footer">
	<div class="row">
      ...
      <p>© 1998-<? echo date('Y'); ?> Коллектор библейской книги. Все права защищены. Воспроизведение в целом или
частично без разрешения запрещено.</p>
    </div>
    <div class="large-3 columns">
     	<p class="right"><a href="http://kbk.ru/contact/">Контакты</a> | <a href="http://www.ministrybooks.org/sitemap.cfm">Карта сайта</a> | <a href="http://www.ministrybooks.org/copyright-policy.cfm">Политика защиты авторских прав</a></p>
    </div>
  </div>
</div>
